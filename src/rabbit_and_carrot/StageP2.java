...
public class StageP2 extends JPanel {
	double width = 900;
    double height = 700;
    ...
    Hook2 hook1 = new Hook2 (width-100, 290);//初始化钩子
    Hook2 hook2 = new Hook2 (width+100, 290);//初始化钩子
    Timer timer;
    ...
    public StageP2() throws IOException {
        
    	sp.setBounds(0,0,900, 700);
    	//System.out.println(hook1.getPullVelocity());
    	//System.out.println(hook2.getPushVelocity());
	...
	void refresh() throws IOException {
        ...
        if ((mineralList.isEmpty() && ! hook1.hasMineral() &&! hook2.hasMineral() )||lifetime <= 0) {
        	next();
        }
        lifetime--;
        hook1.refresh(this);
